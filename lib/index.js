        ...
        case STYLE_TAG_NAME:
          {
            ...
            var currentName_1 = currentScript === null || currentScript === void 0 ? void 0 : currentScript.getAttribute('data-id');
...
var VueIframe = function (_super) {
  __extends(VueIframe, _super);

  function VueIframe(props) {
    var _this = _super.call(this, props) || this;

    _this.rootNodeWrapper = /*#__PURE__*/React.createRef(); // vue挂载节点是根据el再往上找它的爹
    ...
    _this.componentDidUpdate = function () {
      ...
      if (!(visible === _this.visible)) {
        ...
        if (!visible) {
          if (rootNodeWrapper === null || rootNodeWrapper === void 0 ? void 0 : rootNodeWrapper.contains(_this.oWrapper1)) {
            _this.oWrapper1 = rootNodeWrapper === null || rootNodeWrapper === void 0 ? void 0 : rootNodeWrapper.removeChild(_this.oWrapper1);
          } else {
            console.warn('无法卸载该组件, 发生错误的原因可能是没有加载到该组件');
          }
        } else {
          rootNodeWrapper === null || rootNodeWrapper === void 0 ? void 0 : rootNodeWrapper.appendChild(_this.oWrapper1);
        }
      }
    ...
    _this.addComponentToPage = function (rootEleWrapper, isLocal) {
      ...
      if (cssurl) {
        ...
        oLink.href = cssurl;
        isLocal ? document.head.appendChild(oLink) : root === null || root === void 0 ? void 0 : root.appendChild(oLink);
      }

      _this.styleElements.forEach(function (style) {
        root === null || root === void 0 ? void 0 : root.appendChild(style);
      });

      root === null || root === void 0 ? void 0 : root.appendChild(_this.oWrapper2);
      ...
      setTimeout(function () {
         ...
         */
        if (!_this.visible) {
          _this.oWrapper1 = rootEleWrapper === null || rootEleWrapper === void 0 ? void 0 : rootEleWrapper.removeChild(_this.oWrapper1);
        }
...
var VueIframe$1 = function (_super) {
  __extends(VueIframe, _super);
...
var ReactIframe = function (_super) {
